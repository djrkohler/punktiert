 ...
 * neighbors </p> whereas excludes with sprigs connected particles </p> VParticle.neighbors gets automatically updated; selects
...
public class BCollisionGroup implements BehaviorInterface {

	float limit;
	float offset;

	public BCollisionGroup() {
		limit = 0.2f;
		offset = 0;
	}
	 ...
	 */
	public BCollisionGroup(float offset) {
		limit = 0.2f;
		this.offset = offset;
	}
	...
	public BCollisionGroup setLimit(float limit) {
		this.limit = limit;
		return this;
	}
