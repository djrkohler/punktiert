...
public class BWorldBox implements BehaviorInterface {
	...
	/**
	 * constructor input: minimal Vector/ Corner, max Vector/ Corner of your BoundingBox
	 * 
	 * @param _min
	 * @param _max
	 */
	...
	/**
	 * set true, if the Particles should reappear on the other side of the BoundingBoxSpace
	 */
	...
	/**
	 * set true, if the Particles should reappear bounce on the borders of the BoundingBoxSpace
	 */
	...
	/**
	 * @param force the min Corner to set
	 */
	...
	/**
	 * @param force the max Corner to set
	 */
